...
void PhysicsPlayground::InitScene(float windowWidth, float windowHeight)
{
	...
	//Setup static Top Platform 2
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(295.f), float32(-10.f));
	...
	//Setup static Top Platform 3
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(440.f), float32(-10.f));
	...
	//Setup static Wall
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(298.f), float32(40.f));
	...
	//Setup static Wall 2
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(380.f), float32(20.f));
	...
	//Setup static Wall 3
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(485.f), float32(25.f));
	...
	//Setup barrier Wall
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(228.f), float32(-30.f));
	...
	//Setup barrier Wall 2
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(172.f), float32(-30.f));
	...
	//Setup barrier Wall 3
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(200.f), float32(-55.f));
	...
	//Setup Ramp
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(370.f), float32(40.f));
		...
		tempPhsBody = PhysicsBody(entity, BodyType::TRIANGLE, tempBody, points, vec2(0.f,0.f),false,PLAYER,ENEMY|OBJECTS|PICKUP|TRIGGER,0.5f,3.f);
		tempPhsBody.SetColor(vec4(0.f, 1.f, 0.f, 0.3f));
		tempPhsBody.SetRotationAngleDeg(110.f);
	}
	...
	//Box
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_dynamicBody;
		tempDef.position.Set(float32(55.f), float32(-8.f));
	...
	//Box
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_dynamicBody;
		tempDef.position.Set(float32(55.f), float32(40.f));
...
void PhysicsPlayground::KeyboardHold()
{
	...
	if (Input::GetKey(Key::O))
	{
		...
		box.ScaleBody(2 * Timer::deltaTime, 0);
		//boxSprite.GetWidth();
		//boxSprite.SetSizeScale(sca);
		boxSprite.SetHeight(35 + sca * Timer::deltaTime);
		boxSprite.SetWidth(35 + sca * Timer::deltaTime);
		sca += 2;
		std::cout<<"\n" << sca;
	}
